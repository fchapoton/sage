...
'angles':
        {'arc_minute': pi / 10800*pi,
        'arc_second': pi / 648000*pi,
        'degree': pi / 180,
        'grade': pi / 200,
        'quadrant': pi / 2,
        'radian': one,
...
'area':
        {'acre': 316160658 * one / 78125,
        'are': 100,
        'barn': one / 10000000000000000000000000000,
        'hectare': 10000,
        'rood': 158080329 * one / 156250,
        'section': 40468564224 * one / 15625,
        'square_chain': 158080329 * one / 390625,
        'square_meter': 1,
        'township': 1456868312064 * one / 15625},

'capacitance':
        {'abfarad': 1000000000,
        'farad': 1,
        'statfarad': 25000 * one / 22468879468420441},

'charge':
        {'abcoulomb': 10,
        'coulomb': 1,
        'elementary_charge': '1.60217646200000e-19',
        'faraday': 964853399 * one / 10000,
...
'electric_potential':
        ...
        'statvolt': 149896229 * one / 500000,
        'volt': 1},

'energy':
        {'british_thermal_unit': 52752792631 * one / 50000000,
        'btu': 52752792631 / 50000000,
        'calorie': 10467 * one / 2500,
        'electron_volt': '1.60217733000000e-19',
        'erg': one/ 10000000,
        'ev': '1.60217733000000e-19',
        'joule': 1,
        'rydberg': '2.17987200000000e-18',
        'therm': 52752792631 * one / 500},
...
'force':
        {'dyne': one / 100000,
        'gram_weight': 196133 * one / 20000000,
        'kilogram_force': 196133 * one / 20000,
        'kilogram_weight': 196133 * one / 20000,
        'newton': 1,
        'pound_force': 8896443230521 * one / 2000000000000,
        'pound_weight': 8896443230521 * one / 2000000000000,
        'poundal': 17281869297 * one / 125000000000,
        'ton_force': 8896443230521 * one / 1000000000},
...
'illuminance':
        {'foot_candle': 1562500 * one / 145161,
        'lux': 1,
        'phot': 10000},
...
'inductance':
        ...
        'henry': 1,
        'stathenry': 22468879468420441 * one / 25000},
...
'length':
        ...
        'bolt': '4572 * one /125',
        'cable_international': '926 * one /5',
        'cable_us': '27432 * one /125',
        'caliber': '127 * one /500000',
        'centimeter': one / 100,
        'chain': '12573 * one /625',
        'cicero': '125 * one /27706',
        'cubit': '1143 * one /2500',
        'didot': '125 * one /332472',
        'dtp_point': '127 * one /360000',
        'ell': '1143 * one /1000',
        'fathom': '1143 * one /625',
        'feet': '381 * one /1250',
        'fermi': one / 1000000000000000,
        'foot': '381 * one /1250',
        'furlong': '25146 * one /125',
        'hand': '127 * one /1250',
        'inch': '127 * one /5000',
        'kilometer': 1000,
        'league': '603504 * one /125',
        'light_year': '9460730472580800',
        'link': '12573 * one /62500',
        'meter': 1,
        'micron': one / 1000000,
        'mil': '127 * one /5000000',
        'millimeter': one / 1000,
        ...
        'perch': '12573 * one /2500',
        'pica': '127 * one /30000',
        'pole': '12573 * one /2500',
        'rod': '12573 * one /2500',
        'rope': '762 * one /125',
        'skein': '13716 * one /125',
        'stadion': '118491 * one /625',
        'stadium': '115443 * one /625',
        'statute_mile': '201168 * one /125',
        'survey_foot': '1200 * one /3937',
        'survey_mile': '6336000 * one /3937',
...
'mass':
        ...
        'avoirdupois_ounce': '45359237 * one /1600000000',
        'avoirdupois_pound': '45359237 * one /100000000',
        'bale': '45359237 * one /200000',
        'carat': one / 5000,
        'cental': '45359237 * one /1000000',
        'dalton': '1.66053878200000e-27',
        'drachma': "(0.00429234000000000, {'greek':1})",
        'geepound': '14593903 * one /1000000',
        'grain': '6479891 * one /100000000000',
        'gram': one / 1000,
        'gross_hundredweight': '317514659 * one /6250000',
        'hundredweight': '317514659 * one /6250000',
        'kilogram': 1,
        'libra': '0.325971000000000',
        'long_ton': '317514659 * one /312500',
        'metric_ton': '1000',
        'mina': "(0.429234000000000, {'greek':100})",
        'net_hundredweight': '45359237 * one /1000000',
        'obol': "(0.000715380000000000,{'greek':1/6})",
        'ounce': '45359237 * one /1600000000',
        'ounce_troy': '19439673 * one /625000000',
        'pennyweight': '19439673 * one /12500000000',
        'pondus': '0.325969000000000',
        'pound': '45359237 * one /100000000',
        'pound_troy': '58319019 * one /156250000',
        'quintal': '100',
        'shekel': '0.0141000000000000',
        'short_hundredweight': '45359237 * one /1000000',
        'short_ton': '45359237 * one /50000',
        'slug': '14593903 * one /1000000',
        'solar_mass': '1.98892000000000e30',
        'stone': '317514659 * one /50000000',
        'talent': "(25.7540400000000, {'greek':6000})",
        'ton': '45359237 * one /50000',
        'tonne': '1000',
        'wey': '2857631931 * one /25000000'},

'power':
        {'cheval_vapeur': 588399 * one / 800,
        'horsepower': 37284993579113511 * one / 50000000000000,
        'watt': 1},
...
'pressure':
        ...
        'pa': 1,
        'pascal': 1,
        'pounds_per_square_inch': '8896443230521 * one /1290320000',
        'psi': '8896443230521 * one /1290320000',
        'torr': '20265 * one /152'},
...
'resistance':
        ...
        'ohm': 1,
        'statohm': 22468879468420441 * one / 25000},
...
'viscosity_absolute':
        {'poise': one / 10,
        'reyn': 8896443230521 * one / 1290320000},
...
'volume':
        {'bag': '660732565629 * one /6250000000000',
        'barrel': '9936705933 * one /62500000000',
        'board_foot': '18435447 * one /7812500000',
        'bucket': '473176473 * one /31250000000',
        'bushel': '220244188543 * one /6250000000000',
        'butt': '29810117799 * one /62500000000',
        'cord': '884901456 * one /244140625',
        'cubic_meter': 1,
        'cup': '473176473 * one /2000000000000',
        'ephah': '1982197696887 * one /50000000000000',
        'fifth': '473176473 * one /625000000000',
        'firkin': '4091481 * one /100000000',
        'fluid_dram': '473176473 * one /128000000000000',
        'fluid_ounce': '473176473 * one /16000000000000',
        'gallon': '473176473 * one /125000000000',
        'gill': '473176473 * one /4000000000000',
        'hogshead': '29810117799 * one /125000000000',
        'imperial_gallon': '454609 * one /100000000',
        'imperial_pint': '454609 * one /800000000',
        'jeroboam': '473176473 * one /156250000000',
        'jigger': '1419529419 * one /32000000000000',
        'liter':  one / 1000,
        'magnum': '473176473 * one /250000000000',
        'minim': '157725491 * one /2560000000000000',
        'noggin': '473176473 * one /4000000000000',
        'omer': '1982197696887 * one /500000000000000',
        'peck': '220244188543 * one /25000000000000',
        'pint': '473176473 * one /1000000000000',
        'pony': '1419529419 * one /64000000000000',
        'puncheon': '9936705933 * one /31250000000',
        'quart': '473176473 * one /500000000000',
        'register_ton': '55306341 * one /19531250',
        'seam': '220244188543 * one /781250000000',
        'shot': '473176473 * one /16000000000000',
        'stere': 1,
        'tablespoon': '473176473 * one /32000000000000',
        'teaspoon': '157725491 * one /32000000000000',
        'tun': '29810117799 * one /31250000000',
        'uk_gallon': '454609 * one /100000000',
        'uk_pint': '454609 * one /800000000',
        'wine_bottle': 3 * one / 4000}
}
